    ...
    if (level?.id === 1) {
      return (
        <>
          ...
          <Description>{IntroTexts[0]}</Description>
          <Helper />
        </>
      );
    } else if (level?.id === 2) {
      return (
        <>
          <Title style={{ marginBottom: 10 }}>Olá, {user.name} !</Title>
          <Description>{IntroTexts[1]}</Description>
          <Helper />
        </>
      );
    } else if (level?.id === 3) {
      return (
        <>
          <Title style={{ marginBottom: 10 }}>Olá, {user.name} !</Title>
          <Description>{IntroTexts[2]}</Description>
          <Helper />
        </>
      );
    } else if (level?.id === 4) {
      return (
        <>
          <Title style={{ marginBottom: 10 }}>Olá, {user.name} !</Title>
          <Description>{IntroTexts[3]}</Description>
          <Helper />
        </>
      );
    } else if (level?.id === 5) {
      return (
        <>
          <Title style={{ marginBottom: 10 }}>Olá, {user.name} !</Title>
          <Description>{IntroTexts[4]}</Description>
          <Helper />
        </>
      );
    }
